...
panelA <- cowplot::ggdraw() + cowplot::draw_image(img1, scale = 1) +
  ...
  draw_label(expression(paste("50 ", mu, "m")),
    x = 0.27, y = 0.05, fontfamily = "sans", fontface = "plain",
    color = "black", size = 10, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_label("head",
    x = 0.5, y = 0.85, fontfamily = "sans", fontface = "plain",
    color = "black", size = 9, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_label("sg0",
    x = 0.52, y = 0.67, fontfamily = "sans", fontface = "plain",
    color = "black", size = 9, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_label("sg1",
    x = 0.51, y = 0.55, fontfamily = "sans", fontface = "plain",
    color = "black", size = 9, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_label("sg2",
    x = 0.52, y = 0.4, fontfamily = "sans", fontface = "plain",
    color = "black", size = 9, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_label("sg3",
    x = 0.54, y = 0.2, fontfamily = "sans", fontface = "plain",
    color = "black", size = 9, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_label("pygidium",
    x = 0.55, y = 0.03, fontfamily = "sans", fontface = "plain",
    color = "black", size = 9, angle = 0, lineheight = 0.9, alpha = 1
  )

panelB <- ggdraw() + draw_image(img2, scale = 1) +
  draw_label("Synaptic connectivity",
    x = 0.4, y = 0.99, fontfamily = "sans", fontface = "plain",
    color = "black", size = 11, angle = 0, lineheight = 0.9, alpha = 1
  )

panelC <- ggdraw() + draw_image(img3, scale = 1) +
  draw_label("anti-FVRIamide",
    x = 0.3, y = 0.99, fontfamily = "sans", fontface = "plain",
    color = "#0072B2", size = 11, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_label("rhoPhalloidin",
    x = 0.8, y = 0.99, fontfamily = "sans", fontface = "plain",
    color = "#D55E00", size = 11, angle = 0, lineheight = 0.9, alpha = 1
  ) +
  draw_line(x = c(0.1, 0.3), y = c(0.07, 0.07), color = "black", size = 1) +
  draw_label(expression(paste("40 ", mu, "m")),
    x = 0.2, y = 0.1, fontfamily = "sans", fontface = "plain",
    color = "black", size = 10, angle = 0, lineheight = 0.9, alpha = 1
  )
