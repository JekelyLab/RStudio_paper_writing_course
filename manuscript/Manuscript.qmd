...
Here is our abstract. We discovered that medaka fish can eat Arabidpopsis shoop apical meristeme cells to regulate energy metabolism (data not shown).
Here is some **text in bold** *italic* [underline]{.underline} and ^superscript^.
...
Now edit the text, add a few references and press -> Render and see how the changes show up on the rendered document.
It is easier and faster to render your document to html. You will get a very nice dynamic layout that you can read in the browser (use Firefox). You can also render into pdf, but you need to install a version of latex for that. An easy alternative to generate a nice pdf is to open the html version in a browser (in this case Chrome gives the best results) and print to a pdf file.
...
Inserting comments: <!--# I don't agree here -->
You can also use the visual editor and insert -> comment.
