...
Test of git show. And another test.
...
*Platynereis dumerilii* is a marine annelid... [@ozpolat2021]. It is also the coolest model organism. It lives in shallow sea on seagrass. Ischia is a good campling location.
...
We would like to thank the [Jekely lab](https://github.com/JekelyLab) for the [R project template](<https://github.com/JekelyLab/new_paper_template>) we used to write this paper. This work was funded by some funding agency.
We would like to thank all the Platynereis that gave their lives for science.
